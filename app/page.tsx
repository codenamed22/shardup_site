...
const communityPillars = ["Build with peers", "Learn from mentors", "Share real work"];
      ...
      <main className="site-shell">
        <section id="top" className="hero">
          ...
          <p className="hero-copy">
            ShardUp brings alumni and students together to learn, build, and grow through hands-on
            collaboration and steady feedback.
          </p>
        ...
        <section id="about" className="section about-section">
          ...
          <div className="section-copy">
            <p>
              ShardUp is a mentorship-driven technical community. We connect students with alumni
              and peers who care about building strong skills, better habits, and real confidence.
            </p>
            <p>
              The focus is simple: learn together, work on meaningful projects, and create a culture
              where people keep showing up for each other.
            </p>
          </div>
        </section>
